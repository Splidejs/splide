...
export declare const EVENT_OVERFLOW = "overflow";
...
/** @internal */
export declare const EVENT_SLIDE_KEYDOWN = "sk";
export declare const EVENT_SHIFTED = "sh";
export declare const EVENT_END_INDEX_CHANGED = "ei";
